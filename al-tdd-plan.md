...
| `al-build` SKILL | `plugins/cache/bc-agentic-dev-tools/al-build/2.1.2/…/SKILL.md` | Invoked as the full gate in Scaffold/Red/Green/Mutate phases. `pwsh "<skill>/scripts/test.ps1" [-Force]`. Outputs `.output/TestResults/last.xml` + `telemetry.jsonl` |
