...
Writes only `CONTEXT.md`, accepted domain ADRs under `docs/adr/`, and appended entries in `.not-yet-specified.md` (the deferred-question ledger `/al-steer` grooms).
