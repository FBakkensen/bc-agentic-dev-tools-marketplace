...
| `/al-second-opinion` | Cross-family read-only advisory review (shells to Codex). | Before reconciling non-trivial `Test Specification`, `Verification Plan`, mutation lists, refactor checklists, or verification verdicts. |
