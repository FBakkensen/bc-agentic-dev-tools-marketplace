...
| `/al-steer` | Coach and navigator. Reads state, names next step, never edits code. Owns `.out-of-scope/` and `.not-yet-specified.md`. Canonical replan venue. | "Where are we?", "what's next?", trigger fired in another skill. |
