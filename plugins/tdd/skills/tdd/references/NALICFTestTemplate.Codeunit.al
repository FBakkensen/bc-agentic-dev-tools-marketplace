codeunit 50024 "NALICF Test Template"
{
    // ------------------------------------------------------------------------------------------------
    ...
    // 2. RENAME the file to NALICF<Feature>Test.Codeunit.al.
    // 3. RENAME the codeunit object to "NALICF <Feature> Test" and assign a new ID using the al-object-id-allocator skill.
