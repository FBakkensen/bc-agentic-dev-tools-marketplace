...
- **`telemetry.jsonl` capture path.** Currently produced only by `/al-build`'s test runner. If a new harness lands, update `SKILL.md`'s Inspect step and `telemetry-workflow.md`.
